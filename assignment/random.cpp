...
int main()
{
    ...
    while (!end)
    {
        ...
        case 9:
            ...
            break;
        default:
            std::cout << "i dont know anything";
    
        }

        std::cout << "Do you want me to try again? ( Y or N)" << std::endl;

        char go_on;
        std::cin >> go_on;

        end = (go_on == 'N' || go_on == 'n') ? true : false;
    }
    std::cout<< "thats all i have for this day , best wishes" << std::endl;
    return (0);
}
